...
//        return OpenDeliverApplication.getInstance().getResultDetailsRepository().getReadableDatabase().rawQuery(sql, null);
        Cursor c = OpenDeliverApplication.getInstance().getResultDetailsRepository().getReadableDatabase().rawQuery(sql, null);
