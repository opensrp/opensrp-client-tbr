...
////////////////////////////////////////////////////////////////
    ...
    private class SaveTeamLocationsTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Utils.writePreference(OpenDeliverApplication.getInstance().getApplicationContext(), PREF_TEAM_LOCATIONS, StringUtils.join(locationsCSV, ","));
            return null;
        }
        ...
        private ArrayList<String> locationsCSV() {
            ...
            try {
                locationData = new JSONObject(OpenDeliverApplication.getInstance().getContext().anmLocationController().get());
