...
public class RenderContactScreeningCardHelper extends BaseRenderHelper {
    ...
    private SQLiteDatabase getReadableDatabase() {
        return OpenDeliverApplication.getInstance().getRepository().getReadableDatabase();
    }
    ...
    private Map getCommonPersonObjectDetails(String baseEntityId, String tableName) {
        ...
        try {
            ...
            if (cursor.moveToFirst())
                details = OpenDeliverApplication.getInstance().getContext().commonrepository(tableName)
