package org.smartregister.nutrition.service;
...
import static org.smartregister.nutrition.BuildConfig.SYNC_TYPE;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        ...
        httpAgent = OpenDeliverApplication.getInstance().getContext().getHttpAgent();
    ...
    private void handleSync() {
        if (OpenDeliverApplication.getInstance().getContext().IsUserLoggedOut()) {
    ...
    private void pushECToServer() {
        EventClientRepository db = OpenDeliverApplication.getInstance().getEventClientRepository();
        ...
        while (keepSyncing) {
            try {
                ...
                String baseUrl = OpenDeliverApplication.getInstance().getContext().configuration().dristhiBaseURL();
