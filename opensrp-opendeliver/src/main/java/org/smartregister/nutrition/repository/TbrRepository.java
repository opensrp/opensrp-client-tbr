...
public class TbrRepository extends Repository {
    ...
    public TbrRepository(Context context, org.smartregister.Context openSRPContext) {
        super(context, AllConstants.DATABASE_NAME, AllConstants.DATABASE_VERSION, openSRPContext.session(), OpenDeliverApplication.createCommonFtsObject(), openSRPContext.sharedRepositoriesArray());
    }
    ...
    public SQLiteDatabase getReadableDatabase() {
        return getReadableDatabase(OpenDeliverApplication.getInstance().getPassword());
    }

    @Override
    public SQLiteDatabase getWritableDatabase() {
        return getWritableDatabase(OpenDeliverApplication.getInstance().getPassword());
    }
