...
public abstract class BasePatientDetailsFragment extends SecuredFragment implements View.OnClickListener {
    ...
    protected void renderPositiveResultsView(View view, Map<String, String> patientDetails) {
        RenderPositiveResultsCardHelper renderPositiveResultsHelper = new RenderPositiveResultsCardHelper(getActivity(), OpenDeliverApplication.getInstance().getResultsRepository());
    ...
    protected void renderDemographicsView(View view, Map<String, String> patientDetails) {
        ...
        RenderPatientDemographicCardHelper renderPatientDemographicCardHelper = new RenderPatientDemographicCardHelper(getActivity(), OpenDeliverApplication.getInstance().getResultDetailsRepository());
    ...
    protected void renderFollowUpView(View view, Map<String, String> patientDetails) {
        ...
        RenderPatientFollowupCardHelper renderPatientFollowupCardHelper = new RenderPatientFollowupCardHelper(getActivity(), OpenDeliverApplication.getInstance().getResultDetailsRepository());
    ...
    protected void renderServiceHistoryView(View view, Map<String, String> patientDetails) {
        RenderServiceHistoryCardHelper renderServiceHistoryHelper = new RenderServiceHistoryCardHelper(getActivity(), OpenDeliverApplication.getInstance().getResultDetailsRepository());
    ...
    protected void renderContactScreeningView(View view, Map<String, String> patientDetails) {
        RenderContactScreeningCardHelper renderContactScreeningHelper = new RenderContactScreeningCardHelper(getActivity(), OpenDeliverApplication.getInstance().getResultsRepository());
    ...
    protected void renderBMIHeightChartView(View view, Map<String, String> patientDetails) {
        ...
        RenderBMIHeightChartCardHelper renderBMIHeightChartCardHelper = new RenderBMIHeightChartCardHelper(getActivity(), OpenDeliverApplication.getInstance().getResultDetailsRepository());
    ...
    public void showResultMenu(View view, BasePatientDetailActivity activity){
        ...
        ViewConfiguration testResultsConfig = jsonString == null ? null : OpenDeliverApplication.getJsonSpecHelper().getConfigurableView(jsonString);
    ...
    protected void setupViews(View rootView) {
        ...
        ViewConfiguration config = OpenDeliverApplication.getJsonSpecHelper().getLanguage(Utils.getLanguage());
    ...
    protected void processViewConfigurations(View rootView) {
        try {
            String jsonString = OpenDeliverApplication.getInstance().getConfigurableViewsRepository().getConfigurableViewJson(getViewConfigurationIdentifier());
            if (jsonString == null) {
                renderDefaultLayout(rootView);

            } else {
                ViewConfiguration detailsView = OpenDeliverApplication.getJsonSpecHelper().getConfigurableView(jsonString);
                ...
                if (!views.isEmpty()) {
                    ...
                    for (org.smartregister.configurableviews.model.View componentView : views) {
                        ...
                        try {
                            ...
                            String jsonComponentString = OpenDeliverApplication.getInstance().getConfigurableViewsRepository().getConfigurableViewJson(componentView.getIdentifier());
                            ViewConfiguration componentViewConfiguration = OpenDeliverApplication.getJsonSpecHelper().getConfigurableView(jsonComponentString);
                            if (componentViewConfiguration != null) {

                                ConfigurableViewsHelper configurableViewsHelper = OpenDeliverApplication.getInstance().getConfigurableViewsHelper();
                                ...
                                View json2View = OpenDeliverApplication.getJsonSpecHelper().isEnableJsonViews() ? configurableViewsHelper.inflateDynamicView(componentViewConfiguration, viewParent, fallbackView, componentView.isVisible()) : fallbackView;
                                if (componentView.isVisible()) {
                                    json2View.setTag(R.id.VIEW_CONFIGURATION_ID, getViewConfigurationIdentifier());

                                    if (!OpenDeliverApplication.getJsonSpecHelper().isEnableJsonViews()) {
