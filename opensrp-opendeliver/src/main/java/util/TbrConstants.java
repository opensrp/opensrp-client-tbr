...
TbrConstants extends AllConstants {
    ...
    public static final class ENKETO_FORMS {
        public static final String NUTRITION_ENROLLMENT = "nutrition_enrollment";
        public static final String NUTRITION_FOLLOWUP = "nutrition_followup";
        public static final String NUTRITION_CASECLOSING = "nutrition_caseclosing";
