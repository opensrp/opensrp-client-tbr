...
public class ConfigurableViewsRepositoryTest {
    ...
    private TbrRepositoryShadow repositoryShadow = new TbrRepositoryShadow(OpenDeliverApplication.getInstance().getApplicationContext(), OpenDeliverApplication.getInstance().getContext());
