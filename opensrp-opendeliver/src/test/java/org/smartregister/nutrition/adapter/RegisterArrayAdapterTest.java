...
public class RegisterArrayAdapterTest extends BaseUnitTest {
    ...
    public void instantiationWithDefaultConstructorCreatesNonNullInstance() {
        junit.framework.Assert.assertNotNull(new RegisterArrayAdapter(RuntimeEnvironment.application, 0, Collections.EMPTY_LIST, null));
    }
    ...
    public void callingGetItemReturnsCorrectValue() {
        ...
        RegisterArrayAdapter arrayAdapter = new RegisterArrayAdapter(RuntimeEnvironment.application, 0, registers, null);
