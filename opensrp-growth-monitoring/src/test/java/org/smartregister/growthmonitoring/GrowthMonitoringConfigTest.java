...
public class GrowthMonitoringConfigTest {
    ...
    private static final String FEMALE_ZSCORE_FILE = "zscores_female_weight_age.csv";
    private static final String BOYCHILD_ZSCORE_FILE = "zscores_male_weight_age.csv";
